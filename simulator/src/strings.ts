    ...
    Components: {
        ...
        CPU: {
            ...
            contextMenu: {
                ...
                toggleShowStack: "Afficher la pile",
        ...
        CPU_v6: {
            ...
            "LDK": tuple("Load Constant to ACC", "Charge une constante dans l'ACC"),
            "GDW": tuple("Go Down", "Saute vers le bas"),
            "GUP": tuple("Go Up", "Saute vers le haut"),
            "JIZ": tuple("Jump If Z", "Saute vers le bas si Z = 1"),
            "JIC": tuple("Jump If C", "Saute vers le bas si C = 1"),
            "ADM": tuple("Add RAM to ACC", "Additionne la RAM à l'ACC"),
            "SBM": tuple("Sub RAM from ACC", "Soustrait la RAM à l'ACC"),
            "HLT": tuple("Halt", "Arrête le CPU"),
            "STM": tuple("Store ACC to RAM", "Enregistre l'ACC dans la RAM"),
            "ORM": tuple("Or RAM and ACC", "ACC ou RAM"),
            "ANM": tuple("And RAM and ACC", "ACC et RAM"),
            "NOT": tuple("Not ACC", "Complément de l'ACC"),
