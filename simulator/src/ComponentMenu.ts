...
import {param, ParamDef, ParametrizedComponentDef, ParamsFromDefs} from "./components/Component"
...
const componentsMenu: Array<Section> = [{
    ...
    items: [
        ...
        CPUDef.button({ addressInstructionBits: 8, dataBits: 4, addressDataBits: 4, stackBits: 2, instructionBits: 8 }, "CPU", { compat: "cpu", visible: withButton }),
