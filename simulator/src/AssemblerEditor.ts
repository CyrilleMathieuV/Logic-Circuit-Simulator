...
import {
    ...
    style,
    draggable,
    id, applyModifiersTo, input, applyModifierTo, selected, disabled, hidden, maxlength, canvas,
} from "./htmlgen"
...
export class AssemblerEditor {
    ...
    public constructor(editor: LogicEditor) {
        ...
        this.editor.html.mainContextMenu.addEventListener("mousedown",  this.editor.wrapHandler((handler) => {
            console.log("*")
            this.getRAMROMList()
        }))
